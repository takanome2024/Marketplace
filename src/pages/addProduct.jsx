...
export default function AddPage() {
    ...
    return (
        <form onSubmit={handleSave} className="flex justify-center items-center w-screen bg-[#EAF6FF] h-[100vh] ">
            <div className="flex flex-col bg-[#F9FAFB] p-4 rounded-xl">
                ...
                <div className="buttonSection flex flex-col gap-3">
                    {/* <button className="btn btn-xs sm:btn-sm md:btn-md lg:btn-lg xl:btn-xl capitalize rounded-full text-[1rem]">cancel</button> */}
                    <button type="submit" className="btn btn-xs sm:btn-sm md:btn-md lg:btn-lg xl:btn-xl capitalize rounded-full bg-green-600 text-white text-[1rem]">save</button>
                </div>
            </div>
        </form>
    )
